...
public class AddBook implements ActionListener {
    ...
    public void addBookInfo() {
        ...
        b5.setBackground(n1);            // set button background color
        ...
        label2 = new JLabel("Add Book Information");
                ...
                try {
                    ...
                    if (flag == false) {
                        if (rb1.isSelected()) {
                            ...
                            query = "Insert into book_info(title,author,publisher,date_,language_,category,pages,format_,ISBN,weight,listPrice,ourPrice,numbers,status)"
                                    + "values('" + Title + "','" + Author + "','" + Publisher + "','" + date + "','" + Language + "','" + Category + "','" + pg + "','" + Format + "','" + ISBN + "','" + wazan + "','" + lPrice + "','" + oPrice + "','" + num + "','" + b1 + "')";
                        } else {
                            query = "Insert into book_info(title,author,publisher,date_,language_,category,pages,format_,ISBN,weight,listPrice,ourPrice,numbers,status)"
                                    + "values('" + Title + "','" + Author + "','" + Publisher + "','" + date + "','" + Language + "','" + Category + "','" + pg + "','" + Format + "','" + ISBN + "','" + wazan + "','" + lPrice + "','" + oPrice + "','" + num + "','" + b2 + "')";
                        }
                    }
