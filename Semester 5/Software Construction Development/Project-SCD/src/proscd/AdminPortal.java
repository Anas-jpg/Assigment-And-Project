...
public class AdminPortal extends JFrame {
    ...
    AdminPortal() {
        ...
        JLabel name = new JLabel("Admin- Welcome To TheLastChapter-BookStore");
		...
		public void actionPerformed(ActionEvent e) {
            ...
            String pass = "Coder@1234" ;
                    ...
                    try {
                        ...
                        String sqlurla = "Select * from logindata where Username=? and Password=?";
...
//                
		...
		public void actionPerformed(ActionEvent e) {
                    ...
                    SignUpUserAdmin A = new SignUpUserAdmin();
                    A.setVisible(true);
                }
            }
